...
const rules = [
  ...
  { number: "03", title: "Formula del torneo", text: "Il torneo è a eliminazione diretta. Il tabellone può essere completato tramite preliminari oppure tramite ripescaggi automatici, secondo la formula scelta dall’organizzazione." },
  { number: "04", title: "Ripescaggi e spareggi", text: "Le migliori coppie sconfitte sono ordinate per differenza punti e poi per punti segnati. Una parità decisiva viene risolta con un incontro di spareggio." },
